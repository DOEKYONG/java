...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-3">
				작성자 :<input type ="text" class="form-control" placeholder="작성자">
			</div>
		<div class="col-md-3">
		...
		<div class="row">
			...
			내용 : <textarea rows="20" cols="" class="form-control" placeholder="문의 제목을 작성해주세요"></textarea>
			<div class ="row">
				<div class="col-md-3">
				...
				<div class="col-md-4 offset-4 row">
					<div class="col-md-4">
					<input type="submit" value="등록" class="form-control"> <!-- 폼 전송버튼(action->)버튼 -->
					</div>
					<div class="col-md-4">
					<input type="reset" value="다시쓰기" class="form-control">
					</div>
					<div class="col-md-4">
							<a href="#" > <button class="form-control">목록</button> </a>
					</div>
				</div>
