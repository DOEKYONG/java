...
<div class="container">
	...
	<%
		// * 공공데이터 포털
			//  1.URL 가져오기 [ URL : java.net ]
			URL url = new URL("https://api.odcloud.kr/api/3035882/v1/uddi:5fae3cf5-bc15-4eba-87d8-8289b74e659b_201912202015?page=1&perPage=300&serviceKey=PagbtjWMuK62UPv8osy4UV6cAZ6IXvcPArX0Yp%2Bh0TM%2FollN0X1Z7jBu6WMZDTZFuCJDtdHBoaFSIUqQqi6qVQ%3D%3D");
				// 1. URL 클래스 : JAVA에서 HTTP URL 객체화
			// 2. JAVA 해당 URL 읽기 [ 바이트 스트림]
				// 1. BufferdReader : 외부 데이터 읽어올때 사용되는 클래스 
	...
	<form action="안산시약국.jsp"> <!-- 주소 검색 -->
		<input type="text" id="keyword" placeholder="주소" name="keyword">
	...
	<%
		...
		for( int i = 0; i<array.length(); i++) {
			JSONObject jo = array.getJSONObject(i); // i 번째 json객체
			// 검색이 있을경우
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=2481efa758635baf5ee547485a53ef45&libraries=services,clusterer,drawing"></script>
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=2481efa758635baf5ee547485a53ef45"></script>
