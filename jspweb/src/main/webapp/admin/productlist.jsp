...
<body>
	...
	<!-- 상태변경 모달구역 -->
	<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#activemodal">모달실행</button>
...
<!-- 사용자정의 js 호출 --> <script src="/jspweb/js/productlist.js" type="text/javascript"></script>
</body>
</html>