...
'				</tr>';
 ...
 function payment() {
	...
	if(pay_method == null) { // 만약에 결제수단을 선택을 안했으면 
		alert("결제수단을 선택해주세요!")
		return;
	}
      ...
      IMP.request_pay({ // param
          ...
          buyer_email: member["mid"], // 주문자 이메일
          buyer_name: member["mname"],// 주문자 이름
          buyer_tel: member["mphone"], //주문자 전화번호
          buyer_addr:member["maddress"], //주문자 주소
