 ...
 * 
 */
  //  $(function(){t실행문;}) : 문서 실행시 무조건 실행되는 함수 
  	// js식		id 불러오기 .getElementById(id명)	
  	// jquery 식 id 불러오기 $("#id명")
 		// keyup() :해당
...
$.ajax({
	...
	$("#mphone").keyup(function(){
		...
		if(phonej.test(mphone)) {
			...
			$("#phonecheck").html ("010-0000-0000 로 입력해주세요")
		}
	})
...
function sample4_execDaumPostcode() {
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                if(roadAddr !== ''){
                    document.getElementById("adress5").value = extraRoadAddr;
                } else {
                    document.getElementById("adress5").value = '';
                }
