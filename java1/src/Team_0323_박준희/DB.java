...
public class DB {
	...
	public void memberSave() {
		...
		try {
			FileOutputStream outputStream = new FileOutputStream("E:/memberDB.txt");
	...
	public void memberLoad() {
		//
		try {
			FileInputStream inputStream = new FileInputStream("E:/memberDB.txt");
	...
	public void movieSave() {
		try {
			FileOutputStream outputStream = new FileOutputStream("E:/movieDB.txt");
	...
	public void movieLoad() {
		try {
			FileInputStream inputStream = new FileInputStream("E:/movieDB.txt");
			byte[] bytes = new byte[1024]; 
			inputStream.read(bytes); 
			String file = new String(bytes); 
			String[]list = file.split("\n"); 
	...
	public void ticketSave() {
		try {
			FileOutputStream outputStream = new FileOutputStream("E:/ticketDB.txt");
	...
	public void ticketLoad() {
		try {
			FileInputStream inputStream = new FileInputStream("E:/ticketDB.txt");
			byte[] bytes = new byte[1024]; 
			inputStream.read(bytes); 
			String file = new String(bytes); 
			String[]list = file.split("\n"); 
