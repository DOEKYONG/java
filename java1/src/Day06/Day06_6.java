...
public class Day06_6 { //  c s
	...
	// 2. 메뉴 [ 1. 글쓰기 2.글보기 ]
		// 1.글쓰기 [ 제목,내용,작성자,비밀번호를 => 4개변수 -> 객체화 ]
		// 2. 글보기 [ 해당 글번호의  입력받아 해당글 상세페이지(번호,작성자,제목,내용) 표시 ]
			// 글번호는 배열에 저장되는 순서 [ 인덱스 ]
			// 글보기 메뉴
	// 3. 글보기메뉴 [ 1 . 목록보기 2.삭제 3.수정 ]
	...
	public static void main(String[] args) { // m s
		...
		Board[] boardlist = new Board[100];
			// Board 객체를 100개 저장할수있는 1차원 배열 선언
		
		// 프로그램 실행
		while(true) { // 프로그램실행 무한루프 종료조건x
			
			System.out.println("----------커뮤니티-------------");
			///////////////모든게시물조회////////////////////////////////////////////////////
			System.out.println("번호\t작성자\t제목");
			// 배열내 모든 객체(게시물) 출력 반복문
			int index=0 ; // 인덱스변수 =>배열내객체수체크
			for( Board board : boardlist ) {
				if( board != null ) {
					// 만약 해당 board 객체가 내용물이 있으면 출력
			...
			if( ch ==1 ) { // 1 글쓰기
				...
				// 2. 4개 변수를 객체화 [객채를 만들어서 4개변수를 객체내 필드에 저장] 
				...
				for( Board temp : boardlist ) {
					if( temp == null ) {  // 빈공간 찾았으면
						boardlist[i] = board; // 해당 인덱스에 새로ㅓ운객체 저장
						break; // 한번 저장했으면 반복문종료
					}
					i++;
				}
			///////////////////////////////////////////////////////////////////////////				
			...
			////////////////////////////////////////////////////////////////////////////////
				...
				System.out.println("글 번호를입력하세요 : "); int bno = scanner.nextInt();
...
////////////////////////////////////////////글삭제//////////////////////////////////////////////////
					...
					if ( boardlist[bno].password.equals(password)) { // 게시물객채내 비밀번호 == 입력한 비밀번호
						System.out.println(" 알림)) 삭제성공 ");
						boardlist[bno] = null;
					...
					// 삭제후에 삭제된 인덱스 뒤로 한칸씩 앞으로 이동
						// 왜?? 만약에 해당코드가 없을경우 배열내 사이사이 공백발생
					
				
				}//글삭제
///////////////////////////////////////////////////////////////////////////////////////////////////
				else if ( ch2 == 3 ) {
					// 수정시 : 작성자와 비밀번호 입력받아 동일하면 제목과 내용만 수정 
///////////////////////////////////////////////////글수정//////////////////////////////////////////	
					// 1.비밀번호입력받기
					System.out.println(" 알림)) 현 게시물 비밀번호 : ");  String password = scanner.next();
					// 현게시물의 인덱스 객체내 비밀번호가 입력받은 비밀번호가 동일하면
					if (boardlist[bno].password.equals(password)) {
						...
						System.out.println("비밀번호가 다릅니다 !! 수정 실패");
					}
