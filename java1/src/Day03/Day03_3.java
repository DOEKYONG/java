...
//		System.out.println("점수 입력 : "); int 점수 = scanner.nextInt();
//		if(점수 >= 90) {
...
//		}
		 ...
		 * System.out.println("비밀번호 입력 : "); int 비밀번호 = scanner.nextInt();
		 * if(아이디.equals("admin")) { if(비밀번호 == 1234) { System.out.println("로그인성공"); } }
